...
class ButtonCheckDivs extends Component {
  ...
  function Showm(props) {
    return  (<div id = 'TaskList'><div><h4>Task List</h4></div>
             <div> <TaskForm /></div>
            </div>);
  ...
  function Hide(props) {
    return (<div id="hide"><button id="GetCheckList" className = 'CurcleButton' onClick={props.onClick}> <img src="./button_img/list.png" id="GetCheckListImg" alt="checkedList"/>
    </button></div>);
  }
